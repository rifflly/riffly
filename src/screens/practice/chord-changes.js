...
/**
 * Trainer controller — a thin consumer of the shared timing engine, mirroring
 * how Metronome uses it. Calls onBeat for every beat (UI pulse) and onBar on
 * each downbeat (flip the active chord + drive auto-advance).
 */
class ChordTrainer {
  constructor() {
